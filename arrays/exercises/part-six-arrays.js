...
let element3 = ['methane', 'M', 1.558];
let element5 = ['gold', 'Au', 27.003];
let element22 = ['copper', 'C', 35.85];
...
table2.push(element3, element5, element22);
console.log(table);
let tables = []
tables.push(table, table2)
...
console.log(tables[0][0][2]);
console.log(tables[1][1][0]);
console.log(tables[1][2][1]);
