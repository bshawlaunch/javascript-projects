...
let popRem = cargoHold.pop();
console.log(popRem);
console.log(cargoHold);
//3) Remove the first item from the array with shift. Print the element removed and the updated array.

shiftRem = cargoHold.shift();

console.log(shiftRem);
console.log(cargoHold);

//4) Unlike pop and shift, push and unshift require arguments inside the (). Add the items 1138 and ‘20 meters’ to the the array - the number at the start and the string at the end. 
...
console.log(`The cargoHold array consists of, ${cargoHold} and has a length of ${cargoHold.length}`)